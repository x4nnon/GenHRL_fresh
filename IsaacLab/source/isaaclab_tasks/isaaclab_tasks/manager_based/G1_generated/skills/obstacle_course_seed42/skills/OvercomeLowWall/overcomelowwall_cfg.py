...
##
LIN_VEL_Z_L2_WEIGHT = 0
ANG_VEL_XY_L2_WEIGHT = 0
DOF_TORQUES_L2_WEIGHT = 0
DOF_ACC_L2_WEIGHT = 0
ACTION_RATE_L2_WEIGHT = 0
FEET_AIR_TIME_WEIGHT = 0
UNDESIRED_CONTACTS_WEIGHT = 0
FLAT_ORIENTATION_L2_WEIGHT = 0
DOF_POS_LIMITS_WEIGHT = 0
TERMINATION_WEIGHT = -100 # NOT normalised and averaged across the episode length.
HEAD_BEHIND_WEIGHT = 0
HIPS_OVEREXTENDED_WEIGHT = 0
FOOT_CYCLING_WEIGHT = 0
SUCCESS_WEIGHT = 1000 # NOT normalised and averaged across the episode length.
COLLAPSE_WEIGHT = 0
MOVEMENT_DIRECTION_ALIGNMENT_WEIGHT = 0
FEET_SLIDE_WEIGHT = 0
FORWARD_WORKSPACE_WEIGHT = 0

FINAL_LIN_VEL_Z_L2_WEIGHT = 0
FINAL_ANG_VEL_XY_L2_WEIGHT = 0
FINAL_DOF_TORQUES_L2_WEIGHT = 0
FINAL_DOF_ACC_L2_WEIGHT = 0
FINAL_ACTION_RATE_L2_WEIGHT = 0
FINAL_FEET_AIR_TIME_WEIGHT = 0
FINAL_UNDESIRED_CONTACTS_WEIGHT = 0
FINAL_FLAT_ORIENTATION_L2_WEIGHT = 0
FINAL_DOF_POS_LIMITS_WEIGHT = 0
FINAL_TERMINATION_WEIGHT = -1000
FINAL_HEAD_BEHIND_WEIGHT = 0
FINAL_HIPS_OVEREXTENDED_WEIGHT = 0
FINAL_FOOT_CYCLING_WEIGHT = 0
FINAL_SUCCESS_WEIGHT = 1000
FINAL_MOVEMENT_DIRECTION_ALIGNMENT_WEIGHT = 0
FINAL_FEET_SLIDE_WEIGHT = 0
FINAL_FORWARD_WORKSPACE_WEIGHT = 0
FINAL_COLLAPSE_WEIGHT = 0

# Additional joint-specific weights
ANKLE_JOINT_LIMITS_WEIGHT = 0
JOINT_DEVIATION_HIP_WEIGHT = 0
JOINT_DEVIATION_ARMS_WEIGHT = 0
JOINT_DEVIATION_FINGERS_WEIGHT = 0
JOINT_DEVIATION_TORSO_WEIGHT = 0

FINAL_ANKLE_JOINT_LIMITS_WEIGHT = 0
FINAL_JOINT_DEVIATION_HIP_WEIGHT = 0
FINAL_JOINT_DEVIATION_ARMS_WEIGHT = 0
FINAL_JOINT_DEVIATION_FINGERS_WEIGHT = 0
FINAL_JOINT_DEVIATION_TORSO_WEIGHT = 0
    ...
    def __post_init__(self):    
        ...
        for object in ["Object1", "Object2", "Object3", "Object4", "Object5"]:
            ...
            setattr(self, f"randomize_shapes_{object}", EventTerm(
                func=custom_events.randomize_object_shapes,
                mode="reset",
                params={
            ...
            setattr(self, f"randomize_pos_{object}", EventTerm(
                ...
                params={
                    "asset_cfg": SceneEntityCfg(object),
                    "pose_range": {
                        "x": (-0.0, 0.0),     # Add noise to x position
                        "y": (-0.0, 0.0),     # Add noise to y position
                        "yaw": (-0.0, 0.0),   # Add small rotation noise
                    },
                    "velocity_range": {
...
class TerminationsCfg(SuccessTerminationCfg): # change to CollapseTerminationCfg is you want to use it 
    ...
    height_limit = DoneTerm(func=mdp.root_height_below_minimum, params={"minimum_height": 0.35, "asset_cfg": SceneEntityCfg("robot")})

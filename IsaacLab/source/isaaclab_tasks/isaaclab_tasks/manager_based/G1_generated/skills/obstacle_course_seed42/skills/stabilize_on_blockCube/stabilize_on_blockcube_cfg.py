...
COLLAPSE_WEIGHT = -100
MOVEMENT_DIRECTION_ALIGNMENT_WEIGHT = 0.0
...
class TerminationsCfg(SuccessTerminationCfg): # change to CollapseTerminationCfg is you want to use it 
    ...
    height_limit = DoneTerm(func=mdp.root_height_below_minimum, params={"minimum_height": 0.65, "asset_cfg": SceneEntityCfg("robot")})

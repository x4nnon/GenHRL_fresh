...
def JumpOnBlockCube_success(env) -> torch.Tensor:
    '''Determine if the JumpOnBlockCube skill has been successfully completed.
    ...
    success = check_success_duration(env, condition, "stabilize_on_blockCube", duration=0.5)
    if success.any():
...
class SuccessTerminationCfg:
    success = DoneTerm(func=JumpOnBlockCube_success)

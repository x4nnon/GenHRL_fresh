...
PY_SCRIPT="${REPO_ROOT}/genhrl/analysis/plot_wandb_success_rewards_l2.py"

echo "Running L2 HPPO vs Flat plots for ${#TASKS[@]} tasks..."
...
echo "\nAll tasks completed. Plots saved under genhrl/analysis/plots_l2/<task>."

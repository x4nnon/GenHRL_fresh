...
TASK_NAME = os.environ.get("GENHRL_TASK_NAME", "Build_a_tower")
...
parser.add_argument("--normaliser", type=str, default="custom", choices=["custom", "standard", "None"], help="Normalization mode for rewards.")

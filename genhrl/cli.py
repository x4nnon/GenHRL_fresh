...
Examples:
  ...
  # Train with different step requirements for primitives vs composites
  genhrl train Create_Steps --simple --min-primitive-steps 8000 --min-composite-steps 15000
  ...
  genhrl generate "pick up the red ball" --isaaclab-path /custom/path/to/IsaacLab --api-key YOUR_KEY
    ...
    train_parser.add_argument("--min-success-states", type=int, default=20, help="Minimum success states required")
    ...
    train_parser.add_argument("--simple", action="store_true", default=True, help="Use simple training mode - just train each skill for exact number of steps without monitoring")
    ...
    train_parser.add_argument("--video", action="store_true", default=False, help="Enable video recording during training (default: enabled)")
...
def handle_train(args):
    ...
    if args.print_commands:
        ...
        if args.simple:
            ...
            orchestrator.print_training_commands(args.steps, record_video, video_interval, video_length, args.num_envs, args.seed, min_primitive_steps=args.min_primitive_steps, min_composite_steps=args.min_composite_steps)
        else:
    ...
    if args.simple:
        ...
        success = orchestrator.train_all_skills_simple(
            ...
            seed=args.seed,
            min_primitive_steps=args.min_primitive_steps,
            min_composite_steps=args.min_composite_steps
        )
